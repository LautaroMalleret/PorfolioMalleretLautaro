...
[
  ...
  },
  {
    ...
    "images": [
      "/img/api-canchasba/canchasba-api (1).png",
      "/img/api-canchasba/canchasba-api (2).png",
      "/img/api-canchasba/canchasba-api (3).png",
      "/img/api-canchasba/canchasba-api (4).png",
      "/img/api-canchasba/canchasba-api.png"
    ],
  ...
  },
  {
    ...
    "images": [
      "/img/canchasba-web/canchasba.web.png",
      "/img/canchasba-web/canchasba.web1.png",
      "/img/canchasba-web/canchasba.web2.png",
      "/img/canchasba-web/canchasba.web3.png"
    ],
  ...
  },
  {
    ...
    "tech": "Java, UML, Git",
    "images": [
      "/img/Wordle/Wordle-game (1).png",
      "/img/Wordle/Wordle-game (2).png",
      "/img/Wordle/Wordle-game (3).png",
      "/img/Wordle/Wordle-game (4).png",
      "/img/Wordle/Wordle.png"
    ],
  ...
  },
  {
    ...
    "tech": "Java, UML, Git",
    "images": [
      "/img/Album/simulaciones (1).png",
      "/img/Album/simulaciones (2).png",
      "/img/Album/simulaciones (3).png",
      "/img/Album/simulaciones (4).png",
      "/img/Album/simulaciones (5).png"
    ],
  ...
  },
  {
    ...
    "tech": "Java, UML, Git",
    "images": [
      "/img/Barbarianna/Barbarianna.png",
      "/img/Barbarianna/Barbarianna-game (1).png",
      "/img/Barbarianna/Barbarianna-game (2).png",
      "/img/Barbarianna/Barbarianna-game (3).png",
      "/img/Barbarianna/Barbarianna-game (4).png",
      "/img/Barbarianna/Barbarianna-game (5).png"
    ],
  ...
  },
  {
    ...
    "tech": "Assembler ARM",
    "images": [
      "/img/Arm - Wordle/Texto.png",
      "/img/Arm - Wordle/ejemplo.png",
      "/img/Arm - Wordle/inicio.png"
    ],
    ...
    "images": [
      "/img/tecnico/pc (1).jpg",
      "/img/tecnico/pc (2).jpg",
      "/img/tecnico/pc (3).jpg",
      "/img/tecnico/pc (4).jpg",
      "/img/tecnico/pc (5).jpg",
    ],
  ...
  },
   {
    ...
    "images": [
      "/img/mapas/mapas.png",
      "/img/mapas/mapas (1).png",
      "/img/mapas/mapas (2).png",
      "/img/mapas/mapas (3).png",
      "/img/mapas/mapas (4).png",
    ],
